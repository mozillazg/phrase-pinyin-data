...
* `cedict_ts.u8.converted.txt`: [cc-cedict.org](https://cc-cedict.org/) 拼音数据
* `large_pinyin.txt`: `zdic_cibs.txt + zdic_cybs.txt + cedict_ts.u8.converted.txt + pinyin.txt + overwrite.txt` 后的拼音数据
